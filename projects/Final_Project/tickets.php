...
// Prepare a statement to retrieve all tickets in descending order by creation date
$query = "SELECT id, title, priority, status, created_at, description FROM tickets ORDER BY created_at DESC";
...
if (!$tickets) {
    echo "<p>There are no tickets in the database.</p>";
}
