<body class="has-navbar-fixed top">
  ...
  <section class="hero is-info">
    <div class="hero-body">
      <p class="title">
        Designs that Connect, Experiences that Inspire.
      </p>
      <p class="subtitle">
        Transforming ideas into engaging, user-centered digital experiences with seamless design and function
      </p>
      <a href="contact.php" class="button is-medium is-info is-light is-rounded">
        <span class="icon is-large">
          <i class="fab fa-2x fa-pagelines"></i>
        </span>
        <span>Let’s Build Your Vision Together</span>
      </a>
    </div>
  </section>
<!-- END HERO -->
